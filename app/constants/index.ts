export const TIERS = [
  {
    ...
    features: [
      { text: "7-day trial" },
      { text: "1 companion max" },
      { text: "6-minute daily talk credit" },
      { text: "2-minute max per session" },
      { text: "Daily credit resets at midnight" },
      { text: "Watermarked sessions", comingSoon: true },
    ],
    cta: "Stay Free",
    popular: false,
  },
  {
    ...
    features: [
      { text: "Up to 100 companions" },
      { text: "15-minute session length" },
      { text: "Unlimited daily sessions" },
      { text: "Full avatar catalog" },
      { text: "Extended conversation memory", comingSoon: true },
      { text: "Premium avatars (no watermarks)", comingSoon: true },
    ],
    cta: "Go Pro",
    popular: true,
  },
  {
    ...
    features: [
      ...
      { text: "Up to 500 companions" },
      { text: "60-minute session length" },
      { text: "Ultra-low latency", comingSoon: true },
      { text: "Infinite context memory", comingSoon: true },
      { text: "VIP personal onboarding", comingSoon: true },
    ],
